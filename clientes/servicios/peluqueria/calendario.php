...
<script>
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        slotMaxTime: '19:00',
        events: {
            url: 'http://localhost/spa/app/controllers_clientes/agendas/listado_de_agendas_peluquera.php',
            method: 'GET',
            data: { load: true }
        },
        dateClick: function(info) {
            ...
            if (numeroDia == 0) {
              ...
              $('#fecha_semana').html(a)
                ...
                var url = "http://localhost/spa/app/controllers_clientes/agendas/verificar_horario_peluquera.php" ;  
