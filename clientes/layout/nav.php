        ...
        <nav style ="background-color:#ffa6c5" class="navbar navbar-expand-lg ">
            <div class="container-fluid">
                ...
                <div class="navbar-nav">
                    ...
                    <a class="nav-link active" aria-current="page" href="<?php echo $URL ?>/clientes/layout/Guia de usuario.pdf" download="Guia de usuario - Cliente.pdf">Guía de Usuario</a>
                </div>
